...
[![Build and Test](https://github.com/tomlm/Porta.Pty/actions/workflows/BuildAndRunTests.yml/badge.svg)](https://github.com/tomlm/Porta.Pty/actions/workflows/BuildAndRunTests.yml)
...
?              (Static entry point)                        ?
?                                                          ?
?  SpawnAsync(PtyOptions) ? IPtyConnection                ?
???????????????????????????????????????????????????????????
                         ?
                         ?
???????????????????????????????????????????????????????????
?                   PlatformServices                       ?
?         (Platform detection & provider selection)        ?
?                                                          ?
?  ??????????????? ??????????????? ???????????????        ?
?  ?   Windows   ? ?    Linux    ? ?    macOS    ?        ?
...
???????????????????????????????????????????????????????????
          ...
          ?               ?               ?
??????????????????? ??????????????? ???????????????????????
? PseudoConsole   ? ? Unix PTY    ? ? Unix PTY            ?
? Connection      ? ? Connection  ? ? Connection          ?
? (ConPTY API)    ? ? (forkpty)   ? ? (forkpty)           ?
??????????????????? ??????????????? ???????????????????????
```
